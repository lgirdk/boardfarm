...
# sphinx-quickstart on Mon Oct 14 12:39:33 2019.
#
...
latex_documents = [
    (
        master_doc,
        "Boardfarm.tex",
        "Boardfarm Documentation",
        "Matt McClintock, Mike Anderson, and various",
        "manual",
    ),
]
...
man_pages = [(master_doc, "boardfarm", "Boardfarm Documentation", [author], 1)]
