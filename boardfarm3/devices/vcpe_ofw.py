...
class VCPE_HW(CPEHW):
    ...
    def flash_via_bootloader(
        ...
        :raises NotSupportedError: LXC container cannot be flashed yet
        """
        raise NotSupportedError
...
class VCPE_SW(CPESwLibraries):  # pylint: disable=R0904
    ...
    def __init__(self, hardware: VCPE_HW) -> None:
        """Initialise the sofware class.

        :param hardware: the board hw object
        :type hardware: VCPE_HW
        """
        super().__init__(hardware)

    @property
    def wifi(self) -> WiFiHal:
        """Return instance of WiFi component of the software.
...
class VCPE_LXC(CPE, BoardfarmDevice):
    ...
    def __init__(self, config: dict[str, Any], cmdline_args: Namespace) -> None:
        ...
        self._hw: VCPE_HW = VCPE_HW(config, cmdline_args)
        self._sw: VCPE_SW = None
    ...
    @property
    def hw(self) -> VCPE_HW:
        """The Hardware class object for x86 architecture.
