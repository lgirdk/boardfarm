...
# creates a mgmt rt_table. Pushes route details for eth0 (i.e. docker mgmt interface) in mgmt rt_table.
# creates an alias mgmt that allows commands to have internet access via eth0.
# this code is a helper for other functions in this script
isolate_management() {
    local cname=${1}
