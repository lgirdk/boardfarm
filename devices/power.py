...
class Ip9258:
    ...
    def on(self):
        ...
        return urllib2.urlopen('http://' + self._hostname + '/set.cmd?cmd=setpower+p6' + str(self.port) + '=1')

    def off(self):
        print("Power Off Port(%s)\n" % self.port)
        return urllib2.urlopen('http://' + self._hostname + '/set.cmd?cmd=setpower+p6' + str(self.port) + '=0')
